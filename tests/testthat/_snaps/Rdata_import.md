      [58] 444 450 456 463 470 477 484 491 498 505 512 519 526 533 540
...
---
    ...
    Output
      ...
      515    Ergebnisblatt_BAM-M321_OFuchs-sauer_m.xlsx FALSE FALSE
      ...
      579          Ergebnisblatt_BAM-M321_Trimet_m.xlsx FALSE FALSE
      ...
      $CertValPlot$fnc
       ...
       [4] "        function(x) {"                                                         
       [5] "            data.frame(MW = mean(x, na.rm = T), Median = median(x, "           
       [6] "                na.rm = T), SD = sd(x, na.rm = T), n = sum(is.finite(x)))"     
       [7] "        }, .id = \"Lab\")"                                                     
      ...
      [17] "    axis(1, at = 1:nrow(data.stats), labels = data.stats$Lab)"                 
      [18] "    axis(2, las = 2)"                                                          
      [19] "    abline(h = mean(data.stats$MW[!data.stats[, \"Filter\"]]), "               
      [20] "        col = 3, lwd = 2)"                                                     
      [21] "    abline(h = mean(data.stats$MW[!data.stats[, \"Filter\"]]) + "              
      [22] "        c(-1, 1) * sd(data.stats$MW[!data.stats[, \"Filter\"]]), "             
      [23] "        lty = 2, col = grey(0.8))"                                             
      [24] "    segments(x0 = 1:nrow(data.stats), y0 = data.stats$MW - data.stats$SD, "    
      [25] "        y1 = data.stats$MW + data.stats$SD)"                                   
      [26] "    lw <- 0.15"                                                                
      [27] "    segments(x0 = 1:nrow(data.stats) - lw, x1 = 1:nrow(data.stats) + "         
      [28] "        lw, y0 = data.stats$MW - data.stats$SD)"                               
      [29] "    segments(x0 = 1:nrow(data.stats) - lw, x1 = 1:nrow(data.stats) + "         
      [30] "        lw, y0 = data.stats$MW + data.stats$SD)"                               
      [31] "    symbols(x = 1:nrow(data.stats), y = data.stats$MW, circles = rep(lw, "     
      [32] "        nrow(data.stats)), bg = c(3, grey(0.8))[1 + data.stats[, "             
      [33] "        \"Filter\"]], add = T, inches = FALSE)"                                
      [34] "    legend(x = \"topleft\", bty = \"n\", lty = c(1, 2), col = c(3, "           
      [35] "        grey(0.8)), legend = c(\"mean\", \"sd\"))"                             
      [36] "    box()"                                                                     
      [37] "}"                                                                             
      ...
      $stats$fnc
       ...
       [4] "        data.frame(mean = round(mean(x, na.rm = T), precision), "                     
       [5] "            sd = round(sd(x, na.rm = T), precision), n = sum(is.finite(x)), "         
       [6] "            stringsAsFactors = FALSE)"                                                
       [7] "    }, .id = \"Lab\")"                                                                
       [8] "    rownames(lab_means) <- lab_means$Lab"                                             
       [9] "    out <- data.frame(lab_means, Scheffe(data = data), Dixon(lab_means = lab_means), "
      [10] "        Grubbs(lab_means = lab_means), Nalimov(lab_means = lab_means), "              
      [11] "        Cochran(data = data), stringsAsFactors = FALSE)"                              
      ...
      [4] "        \"value\"], data[, \"Lab\"]), mean))))"                                         
      [5] "    plot(value ~ Lab, data = data, main = \"\", ylab = paste0(unique(data[, "           
      [6] "        \"analyte\"])[1], \" [\", unique(data[, \"unit\"])[1], \"]\"))"                 
      [7] "    text(x = jitter(as.numeric(data[, \"Lab\"])), y = data[, \"value\"], "              
      ...
      $mstats$fnc
       ...
       [2] "{"                                                                                                           
       [3] "    lab_means <- plyr::ldply(split(data$value, data$Lab), function(x) {"                                     
       [4] "        data.frame(mean = mean(x, na.rm = T), sd = sd(x, na.rm = T), "                                       
       [5] "            n = sum(is.finite(x)))"                                                                          
       [6] "    }, .id = \"Lab\")"                                                                                       
       [7] "    n <- nrow(lab_means)"                                                                                    
       [8] "    out <- data.frame(Mean = round(mean(lab_means$mean), precision), "                                       
       [9] "        Median = round(median(lab_means$mean), precision), SD = round(sd(lab_means$mean), "                  
      [10] "            precision), MAD = round(stats::mad(lab_means$mean), "                                            
      [11] "            precision), Bartlett_p = formatC(stats::bartlett.test(value ~ "                                  
      [12] "            Lab, data = data)$p.value, format = \"E\", digits = 2), "                                        
      [13] "        ANOVA_p = formatC(anova(lm(value ~ Lab, data = data))$Pr[1], "                                       
      [14] "            format = \"E\", digits = 2), KS_p = formatC(suppressWarnings(stats::ks.test(x = lab_means$mean, "
      [15] "            y = \"pnorm\", mean = mean(lab_means$mean), sd = sd(lab_means$mean))$p.value), "                 
      [16] "            format = \"E\", digits = 2), Skewness = round(moments::skewness(x = lab_means$mean), "           
      [17] "            precision), Agostino_p = NA, Kurtosis = round(moments::kurtosis(x = lab_means$mean), "           
      [18] "            precision), Anscombe_p = NA)"                                                                    
      [19] "    test <- try(moments::agostino.test(x = lab_means$mean), silent = TRUE)"                                  
      [20] "    if (!class(test) == \"try-error\") "                                                                     
      [21] "        out$Agostino_p <- formatC(test$p.value, format = \"E\", "                                            
      [22] "            digits = 2)"                                                                                     
      [23] "    test <- try(moments::anscombe.test(x = lab_means$mean), silent = TRUE)"                                  
      [24] "    if (!class(test) == \"try-error\") "                                                                     
      [25] "        out$Anscombe_p <- formatC(test$p.value, format = \"E\", "                                            
      [26] "            digits = 2)"                                                                                     
      [27] "    return(out)"                                                                                             
      [28] "}"                                                                                                           
      ...
      3      Cu     NA  1  1   1.0000     NA NA         NA 0.00000000  0  0  0  0  0
      4      Mn     NA  1  1   1.0000     NA NA         NA 0.00000000  0  0  0  0  0
      5      Mg     NA  1  1   1.0000     NA NA         NA 0.01553593  0  0  0  0  0
      6      Cr     NA  1  1   1.0000     NA NA         NA 0.00000000  0  0  0  0  0
      7      Ni     NA  1  1   1.0000     NA NA         NA 0.00000000  0  0  0  0  0
               com k          U
      1 0.01539446 2 0.03078891
      2 0.01553593 2 0.03107185
      3 0.00000000 2 0.00000000
      4 0.00000000 2 0.00000000
      5 0.01553593 2 0.03107185
