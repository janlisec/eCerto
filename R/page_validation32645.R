#' @title Validation-Page DIN 32645.
#' @description \code{page_validation} is the module for validation according to DIN 32645.
#' @details Not yet.
...
#'   shiny::shinyApp(
#'     ui = bslib::page_fluid(
#'       eCerto:::page_validation32645UI(id = "test")
#'     ),
...
#'       eCerto:::page_validation32645Server(id = "test", test_data = td)
#'     }
#'   )
#' }
#' @return Nothing
...
page_validation32645UI <- function(id) {
  ns <- shiny::NS(id)
...
#' @noRd
page_validation32645Server <- function(id, test_data = NULL) {
