...
#' @examples
#' rv <- eCerto:::test_rv()
#' shiny::isolate(eCerto:::c_filter_data(
#'   x = eCerto::getValue(rv, c("Certification", "data")),
#'   c_apm = eCerto::getValue(rv, c("General", "apm"))[["Si"]]
#' ))
#' @return A filtered data frame (S_flt, L_flt) without missing values and rounded
