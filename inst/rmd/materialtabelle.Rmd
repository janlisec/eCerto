...
- `char` describes the *char*acteristic uncertainty **ToDo**
...
- `F` columns can be added and will be used to modify `mean` by multiplication yielding `cert_val` $cert\_val=mean*F$
