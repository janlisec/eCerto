...
distribution independently (two one sided tests). This might lead to confusion as 
P-values for both independent tests are displayed within the same column of **Tab.C1**.
However, it allows to keep the output compact. Please use results of **Tab.C1** in
parallel with **Fig.C1** to decide on potential removal of Labs.
