...
tabulated critical values for Dixon up to $n=100$ obtained from
<a href="http://www.statistics4u.com/fundstat_eng/cc_outlier_tests_dixon.html" target="_blank" rel="noopener noreferrer">here</a>.
...
the single Grubbs Test is not significant. Critical values for double Grubbs are only
available for $4 \le n \le 30$.
