...
```{r TabC1, echo=FALSE, message=FALSE, results='asis'}
...
Except for `Cochran`, which tests for outliers with respect to variance, all other 
columns indicate potential outliers regarding lab means.
...
available for **R**. Details regarding the conducted statistical test (implementation, 
parameters) can be found using the following links:

* `r sl("Scheffe", "https://rdrr.io/cran/agricolae/man/scheffe.test.html")` ***Note!*** 
...
`agricolae` package.
* `r sl("Dixon", "https://rdrr.io/cran/outliers/man/dixon.test.html")` ***Note!*** 
...
`r sl("this", "http://www.statistics4u.com/fundstat_eng/cc_outlier_tests_dixon.html")` website. 
Different tables are used according to $n$.
* `r sl("Grubbs", "https://rdrr.io/cran/outliers/man/grubbs.test.html")` ***Note!*** 
...
on `r sl("this", "https://doi.org/10.1007/s10182-011-0185-y")` paper.
* `r sl("Cochran", "https://rdrr.io/cran/outliers/man/cochran.test.html")` ***Note!*** 
