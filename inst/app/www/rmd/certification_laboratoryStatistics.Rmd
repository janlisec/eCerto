...
This test was originally implemented based on a website including the critical values table.
***Note!*** The Nalimov test in its version by Kaiser/Gottschalk is most likely wrong and will be
removed in a future version of *eCerto*. The correct implementation gives results identical to Grubbs.
