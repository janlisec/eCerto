...
***Note!*** The Dixon-Test was developed for small sample sizes and will only work for $3 \le n \le 30$.
...
as well as double version (the two most extreme values are tested against the rest). Similar to Dixon the test is only 
applied for $3 \le n \le 30$.
