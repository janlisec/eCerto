...
The `analyte` column should contain values that match the corresponding data from the certification 
...
measurements have been performed on. `value` and `unit` have to be determined similarly to the data 
from the certification trial obviously to yield a meaningful uncertainty value.

***Note!*** 
`unit` data is neither checked nor converted but used for plot annotation only.
