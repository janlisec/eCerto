...
**Tab.C3** can be exported together with a report as PDF, Word or HTML document using the download section on top of the page.
...
panel (top, `Precision (cert)`). A precision according to DIN 1333 based on $U_{abs}$ is suggested. However, all relative `U` 
