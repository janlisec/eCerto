...
The data and linear model is visualized in **Fig.1**. Here, in addition to the monthly difference
...
The dashed blue line indicates the linear model. It's parameters are transfered to **Tab.1** and are
used to calculate `u_stab`.

![Stability Modul Fig.1](fig/S_Modul_Fig1.png)
