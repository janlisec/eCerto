...
$u_{stab}={|t_{cert} \times s(b_1)| \over \mu}$ where $t_{cert}$ is the expected shelf life 
...
Values from column `u_stab` can be transferred to a user defined column of the 
