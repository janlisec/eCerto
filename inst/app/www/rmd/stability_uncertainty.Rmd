...
The parameters of all linear models are collected in **Tab.1** and obtained from formula 
...
![Stability Modul Tab.1](fig/S_Modul_Tab1.png)
...
in case that matching analyte names are found (indicated in column `Present`).
