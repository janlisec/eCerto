...
```{r TabH1, echo=FALSE, message=FALSE, results='asis'}
x <- eCerto::CRM001$Homogeneity$h_vals
mt <- data.frame("analyte" = c("X","Z"))
eCerto:::styleTabH1(x = x, mt = mt, prec=setNames(c(4,0,2), c("X","Y","Z")), output = "ft_HTML")
```
