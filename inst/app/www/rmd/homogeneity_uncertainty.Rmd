...
A significant ANOVA P-value indicates inhomogenious specimen and is highlighted in red color in **Tab.H1**.
...
(**Tab.C3** in the certification modul). Analytes not present there will be rendered in red.
