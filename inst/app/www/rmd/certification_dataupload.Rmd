...
***Note!*** Please select the range without a header. *eCerto*
...
![Data upload from Excel with preview](fig/M_Modul_Dataupload.png)

***Note!*** Filenames will be stored for reference but imported labs will be
consecutively numbered. In the example above you should import data from sheet
1 of each Excel file located in Range A7:H9, containing 6 replicate measurements of 3
different analytes measured in units as specified in column B.
