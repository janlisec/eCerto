...
***Note!*** `pooling` means that calculations in the material table (`mean`, `sd` and uncertainty columns) are not based on the lab means, but rather on all measured values. This is justified when the between lab variance is smaller than the within lab variance. Selecting this option will also affect `n` being either the number of labs or the number of finite data points.
