...
if (knitr::is_html_output()) {
  ...
  #eCerto:::eCerto_flextable_defaults(flextable::flextable(tab_V1_wr$x$data), digits = prec)
  eCerto:::ft_default(df = tab_V1_wr$x$data, caption = "Working range results", id = "Tab.V1", output = "ft", HTML2ft = TRUE)
}
```
...
if (knitr::is_html_output()) {
  ...
  # ft <- eCerto:::eCerto_flextable_defaults(flextable::flextable(tab_V1_lm$x$data))
  # flextable::set_caption(x = ft, caption = tab_V1_lm$x$caption)
  capt <- gsub("<.+>", "", strsplit(tab_V1_lm$x$caption, "Tab.V1 ")[[1]][2])
  eCerto:::ft_default(df = tab_V1_lm$x$data, caption = capt, id = "Tab.V2", output = "ft", HTML2ft = TRUE, prec = prec)
}
```
...
```{r tab_V1_lox, message=FALSE, resize.width="100%"}
  ...
  if (knitr::is_html_output()) {
    ...
    eCerto:::ft_default(df = tab_V1_lox$x$data, digits = prec)
    eCerto:::ft_default(df = tab_V1_lox$x$data, caption = "Method LOD/LOQ", id = "Tab.V3", output = "ft", HTML2ft = TRUE, prec = prec)
  }
```
...
if (knitr::is_html_output()) {
  ...
  eCerto:::eCerto_flextable_defaults(flextable::flextable(inp), digits = prec+1)
}
```
